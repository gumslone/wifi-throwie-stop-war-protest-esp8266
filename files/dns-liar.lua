...
svr=net.createUDPSocket() --net.createServer(net.UDP)
svr:on("receive",function(svr, dns_pl, port, ip) --(svr,dns_pl)
    decodedns(dns_pl)
    svr:send(port,ip,dns_tr..dns_str1..dns_q..dns_str2..dns_strIP)
